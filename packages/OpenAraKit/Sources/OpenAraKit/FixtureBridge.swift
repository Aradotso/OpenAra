...
public enum FixtureBridge {
    public static let appName = "OpenAraFixture"
    public static let distributedNotificationName = Notification.Name("so.ara.openara.fixture.command")

    public static var stateFileURL: URL {
        URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("openara-fixture", isDirectory: true)
